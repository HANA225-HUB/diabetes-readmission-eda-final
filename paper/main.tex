...
实验使用 Python 3.11.15、pandas 3.0.1、NumPy 2.4.3、scikit-learn 1.8.0\cite{pedregosa2011} 与 CatBoost 1.2.10。数据划分随机种子为 42；CatBoost 主要分支使用预设训练种子 3407；训练集内部 OOF/调参过程使用 20260626 等固定种子，具体见脚本。输入文件为 \texttt{diabetic\_data.csv} 与 \texttt{IDS\_mapping.csv}。完整程序另存为课程要求的 TXT，主流程可在已配置环境中运行：
